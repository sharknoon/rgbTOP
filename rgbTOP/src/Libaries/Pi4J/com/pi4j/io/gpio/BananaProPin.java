 ...
 */
public class BananaProPin extends PinProvider {
    ...
    protected static Pin createDigitalPinNoEdge(int address, String name, EnumSet<PinPullResistance> resistance) {
        return createDigitalPin(BananaProGpioProvider.NAME, address, name, resistance, EnumSet.noneOf(PinEdge.class));
    }

    protected static Pin createDigitalPinNoEdge(int address, String name) {
        return createDigitalPin(BananaProGpioProvider.NAME, address, name, EnumSet.noneOf(PinEdge.class));
    }
    ...
    protected static Pin createDigitalAndPwmPinNoEdge(int address, String name) {
        return createDigitalAndPwmPin(BananaProGpioProvider.NAME, address, name, EnumSet.noneOf(PinEdge.class));
    }
