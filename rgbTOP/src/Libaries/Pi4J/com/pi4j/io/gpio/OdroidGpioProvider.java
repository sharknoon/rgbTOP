...
import Libaries.Pi4J.com.pi4j.jni.AnalogInputEvent;
import Libaries.Pi4J.com.pi4j.jni.AnalogInputListener;
import Libaries.Pi4J.com.pi4j.platform.Platform;
...
public class OdroidGpioProvider extends WiringPiGpioProviderBase implements GpioProvider, GpioInterruptListener, AnalogInputListener {
    ...
    public OdroidGpioProvider() {
        ...
        Libaries.Pi4J.com.pi4j.wiringpi.Gpio.wiringPiSetup();
    }
    ...
    public double getValue(Pin pin) {
        ...
        if (mode == PinMode.ANALOG_INPUT) {
            ...
            double value = Libaries.Pi4J.com.pi4j.wiringpi.Gpio.analogRead(pin.getAddress() - AIN_ADDRESS_OFFSET);
    ...
    protected void updateInterruptListener(Pin pin) {
        ...
        if (listeners.size() > 0) {
            ...
            if (!Libaries.Pi4J.com.pi4j.jni.AnalogInputMonitor.hasListener(this)) {
                Libaries.Pi4J.com.pi4j.jni.AnalogInputMonitor.addListener(this);
            }
            ...
            if(pinModeCache[pin.getAddress()] == PinMode.ANALOG_INPUT) {
                ...
                if(listeners.containsKey(pin) && listeners.get(pin).size() > 0) {
                    // enable interrupt listener for this pin
                    Libaries.Pi4J.com.pi4j.jni.AnalogInputMonitor.enablePinValueChangeCallback(analogPinAddress,
                                                                                 analogInputPollingRate,
                                                                                 analogInputListenerChangeThreshold);
                }
                else {
                    // disable interrupt listener for this pin
                    Libaries.Pi4J.com.pi4j.jni.AnalogInputMonitor.disablePinValueChangeCallback(analogPinAddress);
                }
            }
        }
        else {
            ...
            if (Libaries.Pi4J.com.pi4j.jni.AnalogInputMonitor.hasListener(this)) {
                Libaries.Pi4J.com.pi4j.jni.AnalogInputMonitor.removeListener(this);
            }
        }
    }
}
