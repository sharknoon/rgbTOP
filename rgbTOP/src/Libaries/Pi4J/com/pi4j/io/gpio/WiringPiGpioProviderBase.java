package Libaries.Pi4J.com.pi4j.io.gpio;

import Libaries.Pi4J.com.pi4j.io.gpio.event.PinListener;
import Libaries.Pi4J.com.pi4j.io.gpio.exception.InvalidPinException;
import Libaries.Pi4J.com.pi4j.io.gpio.exception.InvalidPinModeException;
import Libaries.Pi4J.com.pi4j.io.gpio.exception.UnsupportedPinModeException;
import Libaries.Pi4J.com.pi4j.wiringpi.Gpio;
import Libaries.Pi4J.com.pi4j.wiringpi.GpioInterruptEvent;
import Libaries.Pi4J.com.pi4j.wiringpi.GpioInterruptListener;
import Libaries.Pi4J.com.pi4j.wiringpi.GpioUtil;
...
public abstract class WiringPiGpioProviderBase extends GpioProviderBase implements GpioProvider, GpioInterruptListener {
    ...
    public void setMode(Pin pin, PinMode mode) {
        ...
        Libaries.Pi4J.com.pi4j.wiringpi.Gpio.pinMode(pin.getAddress(), mode.getValue());
    }
    ...
    public void setPullResistance(Pin pin, PinPullResistance resistance) {
        ...
        Libaries.Pi4J.com.pi4j.wiringpi.Gpio.pullUpDnControl(pin.getAddress(), resistance.getValue());
    }
...
//    }
    ...
    public void setState(Pin pin, PinState state) {
        ...
        // control GPIO pin
        Libaries.Pi4J.com.pi4j.wiringpi.Gpio.digitalWrite(pin.getAddress(), state.getValue());
    ...
    public PinState getState(Pin pin) {
        ...
        // return pin state
        PinState state = null;
        int ret = Libaries.Pi4J.com.pi4j.wiringpi.Gpio.digitalRead(pin.getAddress());
        if (ret >= 0) {
    ...
    public void setPwm(Pin pin, int value) {
        ...
        if (mode == PinMode.PWM_OUTPUT) {
            ...
            Libaries.Pi4J.com.pi4j.wiringpi.Gpio.pwmWrite(pin.getAddress(), value);
        }
        else if(mode == PinMode.SOFT_PWM_OUTPUT) {
            // set pin software emulated PWM value
            Libaries.Pi4J.com.pi4j.wiringpi.SoftPwm.softPwmWrite(pin.getAddress(), value);
        }
        else {
    ...
    public void setPwmRange(Pin pin, int range){
        ...
        if (mode == PinMode.PWM_OUTPUT) {
            // set pin hardware PWM value
            Libaries.Pi4J.com.pi4j.wiringpi.Gpio.pwmSetRange(range);
        }
        else if(mode == PinMode.SOFT_PWM_OUTPUT) {
            // first, stop the software emulated PWM driver for this pin
            Libaries.Pi4J.com.pi4j.wiringpi.SoftPwm.softPwmStop(pin.getAddress());
            // update the PWM range for this pin
            Libaries.Pi4J.com.pi4j.wiringpi.SoftPwm.softPwmCreate(pin.getAddress(), 0, range);
        }
        else {
    ...
    protected void updateInterruptListener(Pin pin) {
        ...
        if (listeners.size() > 0) {
            ...
            if (!Libaries.Pi4J.com.pi4j.wiringpi.GpioInterrupt.hasListener(this)) {
                Libaries.Pi4J.com.pi4j.wiringpi.GpioInterrupt.addListener(this);
            }
            ...
            if(pinModeCache[pin.getAddress()] == PinMode.DIGITAL_INPUT) {
                ...
                if(listeners.containsKey(pin) && listeners.get(pin).size() > 0) {
                    ...
                    Libaries.Pi4J.com.pi4j.wiringpi.GpioInterrupt.enablePinStateChangeCallback(pin.getAddress());
                }
                else {
                    // disable interrupt listener for this pin
                    Libaries.Pi4J.com.pi4j.wiringpi.GpioInterrupt.disablePinStateChangeCallback(pin.getAddress());
                }
            }
        }
        else {
            ...
            if (Libaries.Pi4J.com.pi4j.wiringpi.GpioInterrupt.hasListener(this)) {
                Libaries.Pi4J.com.pi4j.wiringpi.GpioInterrupt.removeListener(this);
            }
        }
    }
}
