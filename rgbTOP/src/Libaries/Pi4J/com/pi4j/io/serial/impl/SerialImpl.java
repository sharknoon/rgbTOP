package Libaries.Pi4J.com.pi4j.io.serial.impl;
...
import Libaries.Pi4J.com.pi4j.io.serial.Baud;
import Libaries.Pi4J.com.pi4j.io.serial.DataBits;
import Libaries.Pi4J.com.pi4j.io.serial.FlowControl;
import Libaries.Pi4J.com.pi4j.io.serial.Parity;
import Libaries.Pi4J.com.pi4j.io.serial.Serial;
import Libaries.Pi4J.com.pi4j.io.serial.SerialConfig;
import Libaries.Pi4J.com.pi4j.io.serial.SerialDataEvent;
import Libaries.Pi4J.com.pi4j.io.serial.SerialDataEventListener;
import Libaries.Pi4J.com.pi4j.io.serial.SerialFactory;
import Libaries.Pi4J.com.pi4j.io.serial.StopBits;
import Libaries.Pi4J.com.pi4j.io.serial.tasks.SerialDataEventDispatchTaskImpl;
import Libaries.Pi4J.com.pi4j.jni.SerialInterrupt;
import Libaries.Pi4J.com.pi4j.jni.SerialInterruptEvent;
import Libaries.Pi4J.com.pi4j.jni.SerialInterruptListener;
 ...
 * </p>
 *
 * @see Libaries.Pi4J.com.pi4j.io.serial.Serial
 * @see Libaries.Pi4J.com.pi4j.io.serial.SerialDataEvent
 * @see Libaries.Pi4J.com.pi4j.io.serial.SerialDataEventListener
 * @see Libaries.Pi4J.com.pi4j.io.serial.SerialFactory
 *
...
public class SerialImpl extends AbstractSerialDataReaderWriter implements Serial {
    ...
    public void open(String device, int baud, int dataBits, int parity, int stopBits, int flowControl)
        ...
        // open serial port
        fileDescriptor = Libaries.Pi4J.com.pi4j.jni.Serial.open(device, baud, dataBits, parity, stopBits, flowControl);

        // read in initial buffered data (if any) into the receive buffer
        int available = Libaries.Pi4J.com.pi4j.jni.Serial.available(fileDescriptor);

        if(available > 0) {
            byte[] initial_data = Libaries.Pi4J.com.pi4j.jni.Serial.read(fileDescriptor, available);
    ...
    public void open(String device, int baud) throws IOException{
        ...
        open(device,
             baud,
             Libaries.Pi4J.com.pi4j.jni.Serial.DATA_BITS_8,
             Libaries.Pi4J.com.pi4j.jni.Serial.PARITY_NONE,
             Libaries.Pi4J.com.pi4j.jni.Serial.STOP_BITS_1,
             Libaries.Pi4J.com.pi4j.jni.Serial.FLOW_CONTROL_NONE);
    }
    ...
    public void close() throws IllegalStateException, IOException {
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.close(fileDescriptor);
    ...
    public void flush() throws IllegalStateException, IOException{
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.flush(fileDescriptor);
    }
    ...
    public void discardInput() throws IllegalStateException, IOException{
        ...
        // flush data to serial port immediately
        Libaries.Pi4J.com.pi4j.jni.Serial.discardInput(fileDescriptor);
    }
    ...
    public void discardOutput() throws IllegalStateException, IOException{
        ...
        // flush data to serial port immediately
        Libaries.Pi4J.com.pi4j.jni.Serial.discardOutput(fileDescriptor);
    }
    ...
    public void discardAll() throws IllegalStateException, IOException{
        ...
        // flush data to serial port immediately
        Libaries.Pi4J.com.pi4j.jni.Serial.discardAll(fileDescriptor);
    }
    ...
    public void sendBreak(int duration) throws IllegalStateException, IOException{
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.sendBreak(fileDescriptor, duration);
    }
    ...
    public void setBreak(boolean enabled) throws IllegalStateException, IOException{
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.setBreak(fileDescriptor, enabled);
    }
    ...
    public void setRTS(boolean enabled) throws IllegalStateException, IOException{
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.setRTS(fileDescriptor, enabled);
    }
    ...
    public void setDTR(boolean enabled) throws IllegalStateException, IOException{
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.setDTR(fileDescriptor, enabled);
    }
    ...
    public boolean getRTS() throws IllegalStateException, IOException{
        ...
        // get pin state
        return Libaries.Pi4J.com.pi4j.jni.Serial.getRTS(fileDescriptor);
    }
    ...
    public boolean getDTR() throws IllegalStateException, IOException{
        ...
        // get pin state
        return Libaries.Pi4J.com.pi4j.jni.Serial.getDTR(fileDescriptor);
    }
    ...
    public boolean getCTS() throws IllegalStateException, IOException{
        ...
        // get pin state
        return Libaries.Pi4J.com.pi4j.jni.Serial.getCTS(fileDescriptor);
    }
    ...
    public boolean getDSR() throws IllegalStateException, IOException{
        ...
        // get pin state
        return Libaries.Pi4J.com.pi4j.jni.Serial.getDSR(fileDescriptor);
    }
    ...
    public boolean getRI() throws IllegalStateException, IOException{
        ...
        // get pin state
        return Libaries.Pi4J.com.pi4j.jni.Serial.getRI(fileDescriptor);
    }
    ...
    public boolean getCD() throws IllegalStateException, IOException{
        ...
        // get pin state
        return Libaries.Pi4J.com.pi4j.jni.Serial.getCD(fileDescriptor);
    }
    ...
    public void write(byte[] data, int offset, int length) throws IllegalStateException, IOException{
        ...
        Libaries.Pi4J.com.pi4j.jni.Serial.write(fileDescriptor, data, offset, length);
    }
