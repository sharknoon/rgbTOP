package Libaries.Pi4J.com.pi4j.system.impl;
 ...
 * FILENAME      :  BananaPiSystemInfoProvider.java
 *
...
import Libaries.Pi4J.com.pi4j.system.SystemInfo;
import Libaries.Pi4J.com.pi4j.system.SystemInfoProvider;
import Libaries.Pi4J.com.pi4j.util.ExecUtil;
 ...
 */
public class BananaPiSystemInfoProvider extends DefaultSystemInfoProvider implements SystemInfoProvider {
    ...
    public SystemInfo.BoardType getBoardType() throws IOException, InterruptedException, UnsupportedOperationException {
        return SystemInfo.BoardType.BananaPi;
    }
